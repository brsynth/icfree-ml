...
class Test(TestCase):
    ...
    def test_concentrations_to_volumes(self):
        ...
        tested_initial_volumes_df = \
            concentrations_to_volumes_variables[0]
        tested_normalizer_volumes_df = \
            concentrations_to_volumes_variables[1]
        tested_autofluorescence_volumes_df = \
            concentrations_to_volumes_variables[2]
        tested_initial_volumes_summary_df = \
            concentrations_to_volumes_variables[3]
        tested_normalizer_volumes_summary_df = \
            concentrations_to_volumes_variables[4]
        tested_autofluorescence_volumes_summary_df = \
            concentrations_to_volumes_variables[5]
